...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$fps_description = get_bloginfo( 'description', 'display' );
			if ( $fps_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $fps_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
